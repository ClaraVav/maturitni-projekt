...
urlpatterns = [
    ...
    url(r'^clanek/(?P<slug>[-a-zA-Z0-9]+)/$', views.clanek_detail, name="clanek_detail"),
    ...
    url(r'^inzeraty/$', views.bazos, name="inzeraty"),
    url(r'^internet/$', views.internet, name="internet"),
    url(r'^noviny/$', views.bloxnews, name="noviny"),
    url(r'^instablox/$', views.instablox, name="instablox"),
    url(r'^uredni-deska/$', views.uredka, name="uredni_deska"),
    ...
    url(r'^chat/(?P<id>[0-9]+)/$', views.zprava_detail, name="zprava-detail"),
]
